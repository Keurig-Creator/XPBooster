package com.keurigsweb.xpbooster.base.menu.data;
...
//        return player.getInventory().getItemInHand() != null ? player.getInventory().getItemInHand() : player.getInventory().getItemInMainHand();
//    }
}
